...
<!-- Page Content -->
<div class="container">
	<h3 class="my-4">Основные показатели (Линейный график)</h3>
	<hr>
							...
							<div class="divlist">
								<select id="indicator-list" onChange="selectindicator()" class="form-control custom-select" required>
									...
									if (!$link) {
										...
										$sql = "SELECT id_ind,name_ind FROM `indicator` where id_ind between 16 and 19 ORDER BY name_ind DESC";
							...
							<h6>Список регионов:<span class="form-required red-star">*</span>
								<div class="divlist">
									<? include "list_region.php" ?>
										...
										<div><button class="btn btn-primary" id="polar-button">Построить график
											</button>
										</div>
										<div><button class="btn btn-primary" id="line-export-button">Экспорт графика
											</button>
